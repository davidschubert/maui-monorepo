 ...
 * wie die Mitglieder-Verwaltung: `requireSiteTeamGate` prüft die Capability und
 ...
 *
 * `communityId` kommt NIE aus dem Body (siehe siteTeamGate) — sonst kaufte
 * jemand ein Abo auf Kosten einer fremden Community.
 *
 * `billing.manage` trägt nur der OWNER (Davids Entscheidung 2 vom 2026-07-30,
 * packages/core/shared/tenantAuthz.ts): das Abo hängt an der Community, und wer

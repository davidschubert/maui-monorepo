...
export function pickLookupKey(plan: Pick<ControlPlan, 'lookupKey' | 'lookupKeyYearly'>, interval: WorkspaceBillingInterval): string | null {
...
export function isPaidPlanKey(planKey: string | undefined | null, plans: ControlPlanCatalog): boolean {

...
/**
 * Provisionierungs-Jobs (M6-T2) — eng typisierter Vertrag zwischen Control-UI
 * und dem Job-Runner (`pnpm control:jobs`), Vorstufe des Provisioner-Vertrags
...
export interface JobRow extends Models.Row {
  ...
  result: string
  /** Control-User, der den Job angelegt hat. */
  requestedBy: string

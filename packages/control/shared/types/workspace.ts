 ...
 * folgt mit M9/Self-Service, wenn Workspace-Owner echte Control-User werden —
...
export interface WorkspaceRow extends Models.Row {
  ...
  /** Plan-Key aus `pukalani.control.plans` (Code-Katalog, kein Table). */
  plan: string
...
/** Abrechnungsintervall eines Workspace-Abos. Bewusst control-eigen (A14:
 *  control hängt nicht am billing-Layer) — eigener Name vermeidet die

/**
 * Migration comments-017: E8 Etappe 3, AUFRÄUMEN — `tenantId` fällt (comments, guest_authors, comment_votes, embed_sites).
 *
...
console.log(`Migration comments-017 gegen ${endpoint} / Projekt ${projectId} / DB ${db}`)
...
console.log('✔ Migration comments-017 fertig — communityId steht allein.')

/**
 * Migration posts-006: E8 Etappe 3, AUFRÄUMEN — `tenantId` fällt (community_posts, post_votes, poll_votes).
 *
...
console.log(`Migration posts-006 gegen ${endpoint} / Projekt ${projectId} / DB ${db}`)
...
console.log('✔ Migration posts-006 fertig — communityId steht allein.')

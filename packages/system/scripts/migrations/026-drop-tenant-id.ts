/**
 * Migration system-026: E8 Etappe 3, AUFRÄUMEN — `tenantId` fällt (activities, notifications).
 *
...
console.log(`Migration system-026 gegen ${endpoint} / Projekt ${projectId} / DB ${db}`)
...
console.log('✔ Migration system-026 fertig — communityId steht allein.')

/**
 * Produkt Layer: Moderation („etwas melden") — domänen-agnostisch.
 ...
 * docs/referenz/MODERATION-AND-LAYER-BOUNDARIES.md + CONCEPT.md A14.
 *
 * Fundament-Layer: hängt nur von core ab, von keinem Produkt. Extended den

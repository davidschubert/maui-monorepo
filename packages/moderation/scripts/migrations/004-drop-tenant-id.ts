/**
 * Migration moderation-004: E8 Etappe 3, AUFRÄUMEN — `tenantId` fällt (reports).
 *
...
console.log(`Migration moderation-004 gegen ${endpoint} / Projekt ${projectId} / DB ${db}`)
...
console.log('✔ Migration moderation-004 fertig — communityId steht allein.')

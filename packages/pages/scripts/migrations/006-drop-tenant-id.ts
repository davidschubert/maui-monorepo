/**
 * Migration pages-006: E8 Etappe 3, AUFRÄUMEN — `tenantId` fällt (pages).
 *
...
console.log(`Migration pages-006 gegen ${endpoint} / Projekt ${projectId} / DB ${db}`)
...
console.log('✔ Migration pages-006 fertig — communityId steht allein.')

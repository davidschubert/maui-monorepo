/**
 * Migration media-005: E8 Etappe 3, AUFRÄUMEN — `tenantId` fällt (media_items).
 *
...
console.log(`Migration media-005 gegen ${endpoint} / Projekt ${projectId} / DB ${db}`)
...
console.log('✔ Migration media-005 fertig — communityId steht allein.')

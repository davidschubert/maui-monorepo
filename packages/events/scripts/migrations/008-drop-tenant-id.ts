/**
 * Migration events-008: E8 Etappe 3, AUFRÄUMEN — `tenantId` fällt (events, event_rsvps, event_tickets, event_votes).
 *
...
console.log(`Migration events-008 gegen ${endpoint} / Projekt ${projectId} / DB ${db}`)
...
console.log('✔ Migration events-008 fertig — communityId steht allein.')

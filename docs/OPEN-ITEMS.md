...
| 38 · F19 | **`verify-community-suspension.mjs` ist beim ersten Lauf flaky** — die frisch gesetzte Sperre schlägt manchmal >45 s nicht durch (Resolver-Cache 30 s + Kaltstart), dann laufen 14 Prüfungen falsch-rot. Zweiter Lauf ist stets sauber. Warten auf echte Wirkung statt feste Pause. | Niedrig | S | Nein | zweimal live erwischt (2026-08-02) |

...
| --- | --- | --- | --- | --- | --- | --- |
| F1 | **Discussions — entscheidungskomplett.** Alle 7 Entscheidungen gefallen (2026-08-03, § 3.8): Weg B, bleibt im Feed, Name Discussions (Landing-Baustein → „Kommentare"), Like=Upvote, Trust Levels später, nur Guidelines jetzt, Seitenleiste = meine letzten 5. Baubar in 5 Stufen; Stufe 1 (Kern) = Tage. | Mittel | Stufe 1: Tage | Ja: nur noch das Baustart-Go | [DISCUSSIONS-KONZEPT.md](plans/DISCUSSIONS-KONZEPT.md) |

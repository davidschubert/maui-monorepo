...
| --- | --- | --- | --- | --- | --- | --- |
| F1 | **Discussions — Stufen 1+2 gemergt** (2: Aktivitäts-Vertrag `lastActivityAt`, Views-Zähler gepuffert + realtime-still, About mit vier ehrlichen Zahlen, Guidelines-Seed). Offen: Stufen 3–5 (erweiterte Suche + Topic-Zustände · Badges · Trust Levels), Hilfe-Seiten-Umbenennung („Diskussionen"→„Kommentare"), Guidelines-Backfill für Bestands-Communities. | Mittel | Stufe 3: Tage bis Woche | Ja: Priorisierung + 2 offene Fragen | [DISCUSSIONS-KONZEPT.md](plans/DISCUSSIONS-KONZEPT.md) |

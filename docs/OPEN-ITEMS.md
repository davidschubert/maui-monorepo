...
| F47 | 8 — Tage | **Analytics v2, Rest** (Pakete 1+2 — Aktiv-Schalter via Sammel-Site + Zahlen im Dashboard — live seit 2026-08-04): 3. Bewerbung (Landing-Produktseite, Pricing-Highlight — Texte mit David) · 4. Hilfe-Artikel + Datenschutz-Satz (mit A1) · 5. Optionales (Adblock-Proxy, Events/Goals, Mail-Reports). | Mittel | 3+4 ≈ Nachmittag | Ja: Texte (3) abnicken | [ANALYTICS-V2.md](plans/ANALYTICS-V2.md) |

...
| 4 | **Horizont 3 — Pool+Silo Multi-Tenancy** ([Blueprint](plans/HORIZONT-3-POOL-SILO-BLUEPRINT.md); Spike ✅, Schicht 1 ✅, **4.1 Pool-Datenpfad ✅**, **Naht 1/2 Auflösung ✅** beide 2026-07-22, ruhend per maui.tenancy-Gate). Offen: 4.2 Wellen-Migrationen (10 %) · 4.3 Quota (8 %) · 4.4 Onboarding inkl. tenants-Tabelle + Resolver in der Platform-App (👉 nächste Etappe, macht das Gate scharf-testbar) · Naht 4 Tenant-Label-Permissions · Silo-Admin-Key-Registry · Fläche weitere Tabellen | Claude (Etappen-Go: David) | schwer | 40 | 🔨 in Bearbeitung |

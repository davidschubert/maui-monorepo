...
| F47 | 8 — Tage | **Analytics ausbauen:** v1 (Selbstbedienung per Script-Id, ab Personal) ist seit 2026-08-04 live. Rest in Davids Reihenfolge: (a) Plausible-Site AUTOMATISCH je Community anlegen (Sites-API der CE — Scope-Frage prüfen), (b) Besucherzahlen direkt im Dashboard rendern (Stats-API `/api/v2/query`), (c) öffentliche Bewerbung (Landing-Produktseite, Pricing-Highlight — Texte mit David). | Mittel | M–L | Ja: (c) Texte abnicken | Davids Priorisierung |

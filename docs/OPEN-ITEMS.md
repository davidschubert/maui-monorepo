...
**Stand: 26 offen · 12 geparkt/wartend · 7 bewusst zurückgestellt** (Zahlen bei JEDEM Umzug nach COMPLETE mitführen)
...
| 9 · E11b | **`maui` → `pukalani` im ganzen Code** (Paket-Namen, Namensraum, Repo-Name). Entschieden: Inhalt umbenennen, Ordner bleiben. AUSNAHME: die Domain/URL `maui.photos` bleibt unverändert (Davids Vorgabe 2026-07-31). 567 Dateien — die teuerste Umbenennung. | Mittel | XL — sehr breit, aber mechanisch | Nein (entschieden) | [VOKABULAR-AUFRAEUMEN.md](plans/VOKABULAR-AUFRAEUMEN.md) |

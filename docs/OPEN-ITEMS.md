...
| --- | --- | --- | --- | --- | --- | --- |
| F1 | **Discussions — Stufe 1 gemergt, Stufe 2 IN BAU** (Views-Zähler, About, Guidelines; Go 2026-08-04). Landing-URL umgezogen: `/products/comments` (+ 301 von beiden Altpfaden). Danach: Stufen 3–5 (erweiterte Suche + Topic-Zustände · Badges · Trust Levels). Kleiner Rest: die Hilfe-Seiten nennen den Kommentar-Baustein noch „Diskussionen" (`/anleitung/produkte/diskussionen`) — dieselbe Umbenennung wie auf der Landing steht dort aus. | Mittel | Stufe 2: Tage | Nein (Stufen 3–5: Priorisierung) | [DISCUSSIONS-KONZEPT.md](plans/DISCUSSIONS-KONZEPT.md) |

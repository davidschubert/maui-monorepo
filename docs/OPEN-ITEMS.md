...
| --- | --- | --- | --- | --- | --- | --- |
| F1 | **Discussions — Konzept komplett** (Teil 1 Produkt 07-27 · Teil 2 Schnitt 08-03 · Teil 3 Funktionskatalog nach Davids Vorgaben 08-03, Discourse-Klasse: Topics-Tabelle, Sortierung/Filter/Suche, About, Regelwerk-Seiten, ~50 Badges, Trust Levels). Kern bleibt Weg B in Tagen; Vollausbau in 5 Stufen, Badges/Trust Levels eigene Brocken. **7 Entscheidungen offen** (Weg, Feed, Name, Like-Modell, Trust Levels, Privacy je Community, Seitenleiste). | Mittel | Stufen: Tage bis eigenes Projekt | Ja: 7 Entscheidungen | [DISCUSSIONS-KONZEPT.md](plans/DISCUSSIONS-KONZEPT.md) |

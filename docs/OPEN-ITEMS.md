...
| --- | --- | --- | --- | --- | --- | --- |
| F1 | 4 — Tage | **Discussions — Stufen 1–4 live**, dazu kleines Paket (Regeln-Vorlage · Hilfe-Umbenennung · „Thema eröffnen"), Jahrestag + Beitritts-Zahl, und vom GEMEINSAMEN Paket (Davids Go 2026-08-04) alle drei Teilpakete: 1 (mitschreibende Zähler + `posts.editedAt` + Editor), 2 (Mehrfach-Verleihung + Benachrichtigung), 3 (Trust Levels). **Offen bleibt nur noch:** Private Nachrichten — und die nur mit eigenem Konzept (eigene Tabelle, Meldewege, Sperren, DSGVO-Export). | Mittel | PN: Woche+ | Ja: PN-Konzept | [DISCUSSIONS-KONZEPT.md](plans/DISCUSSIONS-KONZEPT.md) |

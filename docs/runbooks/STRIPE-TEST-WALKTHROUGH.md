...
> ⚠️ **VERALTET ab Schritt 2 (A6 Schritt 5, 2026-07-31) — nicht nachklicken.**
> Die Workspace-Welt ist gefallen (Migration control-031): **die Community
> zahlt**, unter `<community-host>/dashboard/settings/subscription` („Abo &
> Rechnung", nur Owner). Was genau falsch ist, was unverändert richtig bleibt
> und die Regel „der nächste Durchlauf schreibt die Anleitung mit und entfernt
> danach diesen Kasten": **A2a** in
> [OPEN-ITEMS.md](../OPEN-ITEMS.md#a2a).

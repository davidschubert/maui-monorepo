export default defineNuxtConfig({
  ...
  extends: ['../../packages/themes', '../../packages/admin', '../../packages/blueprint', '../../packages/comments', '../../packages/posts', '../../packages/events', '../../packages/media', '../../packages/billing', '../../packages/courses', '../../packages/activity', '../../packages/messages', '../../packages/moderation', '../../packages/analytics', '../../packages/domains', '../../packages/core', '../../packages/system'],

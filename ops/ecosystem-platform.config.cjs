...
// pm2-Ecosystem für platform.pukalani.app im CLUSTER-Mode (instances: 1).
...
const ENV_FILE = '/home/ploi/platform.pukalani.app/.env'
const CURRENT = '/home/ploi/releases/platform/current'
